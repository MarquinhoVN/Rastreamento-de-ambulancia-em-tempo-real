...
#include <TinyGPSPlus.h> // Biblioteca para comunicação com o GPS

// Configuração do Wi-Fi
const char* ssid = "Macuxi Digital"; // Nome da rede Wi-Fi
const char* password = "@Macuxi#ufrr35anos"; // Senha do Wi-Fi
const char* server = "https://glitch.com/edit/#!/chartreuse-meteor-breadfruit?path=server.js%3A4%3A0"; // URL do servidor
